...
window.MODEL_CATALOG = {
  ...
  vision: [
    ...
    {
      id: 'yolov11', name: 'YOLOv11', icon: 'eye', domain: 'vision',
      capabilities: ['detect'],
    ...
    {
      id: 'yolov8', name: 'YOLOv8', icon: 'eye', domain: 'vision',
      capabilities: ['detect'],
    ...
    {
      id: 'yolov8-pose', name: 'YOLOv8-Pose', icon: 'eye', domain: 'vision',
    ...
    {
      id: 'yolov8-seg', name: 'YOLOv8-Seg', icon: 'eye', domain: 'vision',
